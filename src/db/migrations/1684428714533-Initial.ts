...
export class Initial1684428714533 implements MigrationInterface {
    name = 'Initial1684428714533'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "subscribers" ("id" SERIAL NOT NULL, "chatId" character varying NOT NULL, "service" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "subscribedGroup" character varying, "subscribedLector" character varying, "facultyId" character varying NOT NULL, "subscribedToNotifications" boolean NOT NULL DEFAULT true, CONSTRAINT "UQ_45f6f1272318fbec4ac6daafa31" UNIQUE ("chatId", "service"), CONSTRAINT "PK_cbe0a7a9256c826f403c0236b67" PRIMARY KEY ("id"))`);
